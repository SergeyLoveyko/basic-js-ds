...
module.exports = class BinarySearchTree {
  ...
  add(data) {
    ...
    function addWithin(node, data) {   //  Находясь на какой-то ВЕРИШИНЕ, поняли что нужно идти (либо влево либо в право)
      ...
      if (node.data === data) {     //  Если такой УЗЕЛ уже СУЩЕСТВУЕТ. Мы дошли нашем пермещением(либо в право либо в лево) к нужному месту, куда нужно ставить элемент. И ЗНАЧЕНИЕ в этом УЗЛЕ Совпадает со ЗНАЧЕНИЕМ с тем элементом что мы хотим ДОБАВИТЬ
